...
<div class="container mt-5">
    ...
    <a href="{{ route('admin.proveedor.productos.create', $proveedor) }}" class="btn btn-primary mb-4">
            ...
            <table class="table table-bordered text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.proveedor.productos.edit', [$proveedor, $producto->id]) }}" 
                               class="btn btn-warning btn-sm">
                                <i class="bi bi-pencil-square"></i>
                            </a>

                            <form action="{{ route('admin.proveedor.productos.destroy', [$proveedor, $producto->id]) }}"
